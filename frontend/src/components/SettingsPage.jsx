          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '16px' }}>
            ...
            <div 
              ...
              style={{
                ...
                padding: '14px 16px',
                borderRadius: '12px',
                border: language === 'mr' ? '2px solid #4F46E5' : '1px solid var(--border-color, #e2e8f0)',
                backgroundColor: language === 'mr' ? '#EEF2FF' : 'var(--bg-primary, #ffffff)',
                cursor: 'pointer',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary, #0f172a)' }}>
                    {t('settingsPage.marathiTitle', 'मराठी (Marathi)')}
                  </div>
                  <div style={{ fontSize: '0.775rem', color: 'var(--text-secondary, #64748b)' }}>
                    {t('settingsPage.marathiDesc', 'मराठी इंटरफेस (MR)')}
                  </div>
                </div>
              </div>
              {language === 'mr' && <CheckCircle2 size={18} style={{ color: '#4F46E5' }} />}
            </div>
            ...
            <div 
              ...
              style={{
                ...
                padding: '14px 16px',
                borderRadius: '12px',
                border: language === 'ar' ? '2px solid #4F46E5' : '1px solid var(--border-color, #e2e8f0)',
                backgroundColor: language === 'ar' ? '#EEF2FF' : 'var(--bg-primary, #ffffff)',
                cursor: 'pointer',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary, #0f172a)' }}>
                    {t('settingsPage.arabicTitle', 'العربية (Arabic)')}
                  </div>
                  <div style={{ fontSize: '0.775rem', color: 'var(--text-secondary, #64748b)' }}>
                    {t('settingsPage.arabicDesc', 'الواجهة العربية (AR)')}
                  </div>
                </div>
              </div>
              {language === 'ar' && <CheckCircle2 size={18} style={{ color: '#4F46E5' }} />}
            </div>
            ...
            <div 
              ...
              style={{
                ...
                padding: '14px 16px',
                borderRadius: '12px',
                border: language === 'gu' ? '2px solid #4F46E5' : '1px solid var(--border-color, #e2e8f0)',
                backgroundColor: language === 'gu' ? '#EEF2FF' : 'var(--bg-primary, #ffffff)',
                cursor: 'pointer',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary, #0f172a)' }}>
                    {t('settingsPage.gujaratiTitle', 'ગુજરાતી (Gujarati)')}
                  </div>
                  <div style={{ fontSize: '0.775rem', color: 'var(--text-secondary, #64748b)' }}>
                    {t('settingsPage.gujaratiDesc', 'ગુજરાતી ઇન્ટરફેસ (GU)')}
                  </div>
                </div>
              </div>
            ...
            <div 
              ...
              style={{
                ...
                padding: '14px 16px',
                borderRadius: '12px',
                border: language === 'ta' ? '2px solid #4F46E5' : '1px solid var(--border-color, #e2e8f0)',
                backgroundColor: language === 'ta' ? '#EEF2FF' : 'var(--bg-primary, #ffffff)',
                cursor: 'pointer',
                transition: 'all 0.2s ease'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary, #0f172a)' }}>
                    {t('settingsPage.tamilTitle', 'தமிழ் (Tamil)')}
                  </div>
                  <div style={{ fontSize: '0.775rem', color: 'var(--text-secondary, #64748b)' }}>
                    {t('settingsPage.tamilDesc', 'தமிழ் இடைமுகம் (TA)')}
                  </div>
                </div>
              </div>
              {language === 'ta' && <CheckCircle2 size={18} style={{ color: '#4F46E5' }} />}
            </div>
          </div>
        </div>
